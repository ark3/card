...
/**
 * A card, as `BRIEF.md` "What this project changes about the format" defines
 * it: two optional list-valued frontmatter fields, one `# ` headline, and
 * prose — and `closed`, the one field `card close` writes rather than the
 * owner.
 */
export type Card = {
  labels: string[];
